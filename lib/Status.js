...
function Status(source) {
  ...
  // this.isQuote (Add according to retweet)
  this.sourceTweet = source.retweeted_status ? source.retweeted_status : null;
...
Status.prototype.sourceTweetAsSQLiteValues = function() {
  // TODO: Return source tweet values
};

Status.prototype.getCSVHeader = function(delimiter) {
  var header = ["ID", "CREATED_AT", "TEXT", "IS_RETWEET", "LANG",
    "IN_REPLY_TO_STATUS", "IN_REPLY_TO_USER", "USED_URLS", "USED_HASHTAGS", "POSITIVE_SENTIMENT_SCORE", "NEGATIVE_SENTIMENT_SCORE",
