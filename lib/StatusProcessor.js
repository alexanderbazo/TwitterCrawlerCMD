...
function StatusProcessor() {
   ...
   * @return {Promise} Returns a Promise that will be resolved when the result set was saved to disk
   */
  function save() {
    return new Promise(function(resolve) {
      if (options.csv === true) {
   ...
   * @return {Promise} Returns a Promise that will be resolve when the result set was stored in the database
   */
  function store() {
    return new Promise(function(resolve) {
