...
const path = require("path"),
  ...
  DEFAULT_SENTISTRENGTH_PATH = "sentistength",
...
function OptionsParser() {
  ...
  function parse(options) {
    ...
    if (options.sentistength) {
      result.sentistength = true;
      result.sentistengthPath = options.sentistength === true ? DEFAULT_SENTISTRENGTH_PATH :
        options.sentistength;
    }
